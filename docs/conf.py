"""
A conf.py file placeholder under the docs folder.
This file will be reworked as the documentation for the project is developed.
"""

#
# pyos_wnsong documentation build configuration file
#
import os
import sys
...
project = "pyos_wnsong"
copyright = "Copyright © 2026 William Song"
...
# built documents.
try:
    version = importlib.metadata.version("pyos_wnsong")
